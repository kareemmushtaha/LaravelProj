                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('twoFactor.check') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="two_factor_code" type="text" class="form-control{{ $errors->has('two_factor_code') ? ' is-invalid' : '' }}" required autofocus placeholder="{{ trans('global.two_factor.code',[],session('locale')) }}">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary px-4">
                                    {{ trans('global.two_factor.verify',[],session('locale')) }}
                                </button>
                            </div>
                            <div class="col-6 text-right">
                                ...
                                <a class="btn btn-danger px-4" href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
                                    {{ trans('global.logout',[],session('locale')) }}
                                </a>
                            </div>
                        </div>
                    </form>
