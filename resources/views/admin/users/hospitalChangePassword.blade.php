...
@section('title',__('global.change_password'))
@section('content')
    @include('includes.hospital.toolbar')
        ...
        <div class="container">
            ...
            <div class="card card-custom example example-compact">
                <div class="card-header">
                    <h3 class="card-title">{{__('cruds.change_password')}}</h3>
                        ...
                        <div class="row">
                            <div class="col-6 mb-10">
                                <label for="exampleFormControlInput1"
                                       class="required form-label">{{__('cruds.new_password')}}</label>
                                <input type="password" class="form-control" placeholder="{{__('cruds.new_password')}}"
                            ...
                            <div class="col-6 mb-10" id="email">
                                <label for="exampleFormControlInput1"
                                       class="required form-label">{{__('cruds.confirm_password')}}</label>
                                <input type="password" class="form-control"
                                       placeholder="{{__('cruds.confirm_password')}}" value="" name="password_confirmation"
                            ...
                            <div class="row">
                                <div class="col-lg-9 ml-lg-auto">
                                    <button class="btn btn-primary mr-2" type="button"
                                            id="btn_change_password"> {{ trans('global.save') }}</button>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#btn_change_password', function (e) {
            $('#btn_change_password').html('{{trans('global.save')}} <i class="fa fa-spinner fa-spin"></i>');
            e.preventDefault();
            $('.errors').text('');
            ...
            $.ajax({
                ...
                url: "{{ route("hospital.user.saveChangePassword") }}",
