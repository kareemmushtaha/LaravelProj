@extends('layouts.lab')
@section('title',trans('global.edit') .' '. trans('cruds.educations.title_singular'))
@section('content')
        ...
        <div class="container">
            ...
            <div class="card card-custom example example-compact">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('global.edit') }} {{ trans('cruds.educations.title_singular') }}</h3>
    ...
    <script>
        ...
        $(document).on('click', '#btn_save', function (e) {
            ...
            $.ajax({
                type: 'post',
                enctype: 'multipart/form-data',
                url: "{{route("lab.education.update",$education->id)}}",
