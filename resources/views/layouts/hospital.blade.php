...
<!--begin::Head-->
@include('includes.hospital.head')
<!--end::Head-->
...
<body id="kt_body"
      ...
      style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px"><!--begin::Main-->
<!--begin::Main-->
<!--begin::Root-->
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        <!--begin::Aside-->
    @include('includes.hospital.sidebar')
    <!--end::Aside-->
        <!--begin::Wrapper-->
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            <!--begin::Header-->
        @include('includes.hospital.header')
        <!--end::Header-->
            <!--begin::Content-->
            ...
            <!--end::Content-->
            <!--begin::Footer-->
        @include('includes.hospital.footer')
        <!--end::Footer-->
        </div>
        <!--end::Wrapper-->
    </div>
...
<script>
    $(document).on('change', '#category_id', function (e) {
        ...
        $.ajax({
            type: 'post',
            enctype: 'multipart/form-data',
            url: "{{ route("admin.filterSubcategory") }}",
            data: {'category_id': category_id}, // send this data to controller
            dataType: 'json',
            success: function (data) {
                $('select[name="subcategory_id"]').empty();
                $('select[name="subcategory_id"]').append('<option value="">{{trans('cruds.offer.fields.subcategory')}}</option>');
