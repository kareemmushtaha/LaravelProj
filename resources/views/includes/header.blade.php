...
{{--                                        </div>--}}
                                        <a href="#"
                                           class="fw-bold text-muted text-hover-primary fs-7">{{auth()->user()->getTranslationName()}}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
                            ...
                            <!--begin::Menu item-->
                                 <div class="menu-item px-5">
                                    <a href="{{route('admin.user.changePassword')}}" class="menu-link px-5">{{trans('global.account_details')}}</a>
                                </div>
